...
- **Claude Codeスキル**: `/localflow-task` スキルによるシームレスなAI駆動タスク管理
...
プロジェクトに `.claude/skills/localflow-task/SKILL.md` が生成され、Claude Codeに `/localflow-task` スキルが登録されます。

### スキルで何ができるか

`/localflow-task` スキルはClaude Codeに完全なタスク管理ワークフローを提供します:
