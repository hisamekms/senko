...
- [OTel Tracing Operations Guide](docs/en/guides/tracing.md) — Claude Code integration, `event.name` queries on Jaeger / Tempo / console, Aviary integration, audit filters, security
...
- [Tracing Reference](docs/en/reference/tracing.md) — business event (`event.name` LogRecord) catalog, enduser / target / Resource attribute schema, baggage / traceparent propagation, Remote OTel env
