...
mod tests {
    ...
    fn skill_md_covers_all_commands() {
        let commands = [
            ...
            "senko task cancel",
            "senko task deps add",
            "senko task deps remove",
            "senko task deps set",
            "senko task deps list",
            "senko task dod check",
            "senko task dod uncheck",
            "senko project members list",
            "senko project members add",
            "senko project members remove",
            "senko project members set-role",
            "senko config",
        ];
        for cmd in commands {
            assert!(
