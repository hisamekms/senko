...
echo "[1] default mode (direct) completes without pr_url"
...
run_lf task edit "$TASK_ID5" --pr-url "https://github.com/org/repo/pull/99" > /dev/null
DEFAULT_OUT="$(run_lf task complete "$TASK_ID5")"
