...
SKILL_PATH="$TEST_PROJECT_ROOT/.claude/skills/senko/SKILL.md"
...
rm -f "$TEST_PROJECT_ROOT/.claude/skills/senko/SKILL.md"
OUTPUT="$(run_lf skill-install)"

if [[ -f "$TEST_PROJECT_ROOT/.claude/skills/senko/SKILL.md" ]]; then
